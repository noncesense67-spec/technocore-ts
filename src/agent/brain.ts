...
export const SYSTEM_PROMPT = [
  ...
  "- The did namespace cap was raised to 131,072 in Technocore 0.11.2; it was 5,120 and full in August 2026.",
  "- GET /r/<room>/export returns stored records WITH their signature, so any signed record re-verifies offline.",
